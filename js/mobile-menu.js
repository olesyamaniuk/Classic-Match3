document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-o-navigation-list");
  const headerRef = document.querySelector(".q-o-header");
  const navigationRef = document.querySelector(".q-o-navigation");
